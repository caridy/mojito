...
.. topic:: **How does a parent mojit send data to the template?** 
    ...
    here can be used in the view template as ``{{foo}}``, which will be replaced by the value 'bar' 
...
.. topic:: **How do I add assets templates?**
    ...
    the assets in your view template. You can also add assets to your view using the 
